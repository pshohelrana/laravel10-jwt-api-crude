...
<style>
 ...
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Loanactive</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Show Loanactive</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Loanactive ID:</b></td><td><input type="text" style="width:60px" value="{{$loanactive->id}}"  readonly/></td></tr>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>     
                     ...
                     @foreach($loansystems as $loansystem)
                        <tr>
                            <th>{{$sn++}}</th>
                            <th>{{$loansystem->name}}</th>
                            <th>{{$loansystem->principle}}</th>
                            <th>{{$loansystem->interest_rate}}</th>                     
                            <th>{{$loansystem->interst}}</th>
                            <th>{{$loansystem->principle*$loansystem->interest_rate-$loansystem->interst}}</th>
                            <th></th>
                        </tr>  
                          <?php
                            $total+=$loansystem->principle*$loansystem->interest_rate-$loansystem->interest;
                          ?>
                     @endforeach
                    </tbody>
                  </table>
