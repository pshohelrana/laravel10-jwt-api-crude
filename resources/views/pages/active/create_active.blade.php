...
<style>
 ...
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Create Loan Active</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Create Loan Active</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Loan Active ID:</b></td><td><input type="text" style="width:60px" value="<?php //echo Order::getLastOrderId()+1;?>"  readonly/></td></tr>
                    <tr><td><b>Loan Active Date:</b></td><td><input type="text" id="txtOrderDate" value=<?php echo date("d-m-Y");?> /></td></tr>
                    <!-- <tr><td><b>Due Date:</b></td><td><input type="text" id="txtDueDate" value=< echo date("d-m-Y");?> /></td></tr> -->
                  </table>
                </div>
                <!-- /.col -->
              </div>
                    ...
                    <tr>
                      ...
                      <th>
                       ...
                       <select id="cmbProduct" name="cmbProduct">
                        ...
                        <th><input type="text" id="txtAmount" /></th>
    ...
    <script>
      $(function() {  
        ...
        $("#txtActiveDate").datepicker({dateFormat: 'dd-mm-yy'});
        ...
        $("#btnProcessActive").on("click",function(e){
           
            e.preventDefault();            

              let customer_id=$("#cmbLoanapplicant").val();
              var token = $("input[name='_token']").val();
              var method = $("input[name='_method']").val();
                            
              let order_date=$("#txtActiveDate").val();
              ...
              $.ajax({
                url:"{{route('actives.store')}}",
                type:'POST',               
                data:{
                  _token:token,
                  _method:method,
                  "cmbLoanapplicant":loanapplicant_id,
                  "txtActiveDate":active_date,
                  "txtDueDate":due_date,
                  "txtAddress":address,
           ...
           $.ajax({
             ...
             success:function(res){
              ...
              let product=JSON.parse(res);
               //console.log(product);
              $("#txtAmount").val(product.offer_price);
              $("#txtInterest").val(1);
              $("#txtInterest").focus();
             }
           });
        ...
        $("#txtInterest").on("keyup",function(e){           
          if(e.which==13){
            $("#txtInterest").focus();
          }
        });
        ...
        //Show customer other information
        $("#cmbLoanapplicant").on("change",function(){          
          let id=$(this).val();  
           ...
           $.ajax({
             ...
             // let customer=JSON.parse(res);
                console.log(res);
              $(".loanapplicant-info").html(res.mobile);
             }
           });
        });      
    ...
    //------------------Cart Functions----------//      
      ...
      function addToCart(){
            ...
            let interest_rate=$("#txtInterest_rate").val();
            let interest=$("#txtInterest").val();
            let total_interest=interest*interest_rate;
            let subtotal=amount*interest+total_interest;
       ...
       function printCart(){
          let cart= getCart();            
           ...
           $.each(cart,function(i,item){
             ...
             subtotal+=item.amount*item.interest_rate+item.interest;
             let $html="<tr>";            
             $html+="<td>";
             $html+=sn;
             $html+="</td>";
